...
?>
<?php $cwGlobal->dev_only_options($cuid, "/u/$u/teams"); ?>
<div class="cw-util-bar">
    <?php $cwGlobal->getUserBreadcrumbs($profileData, "Teams"); ?>
...
<div class="cw-header">
    <div class="flex items-center">
        <div class="cw-title-box">
            <h1><?php echo $profileData->displayName; ?>: Teams</h1>
        </div>
...
<div class="row cw-row">
    <?php // Get all teams 
    $allTeams = $TeamDB->getUserTeamList($cuid); 
